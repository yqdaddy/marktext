...
export default function (keybindings) {
  return {
    id: 'formatMenuItem',
    label: t('menu.format.label', 'Format'),
    submenu: [{
      id: 'strongMenuItem',
      label: t('menu.format.bold', 'Bold'),
      type: 'checkbox',
      ...
      id: 'emphasisMenuItem',
      label: t('menu.format.italic', 'Italic'),
      type: 'checkbox',
      ...
      label: t('menu.format.underline', 'Underline'),
      type: 'checkbox',
      ...
      label: t('menu.format.superscript', 'Superscript'),
      type: 'checkbox',
      ...
      label: t('menu.format.subscript', 'Subscript'),
      type: 'checkbox',
      ...
      label: t('menu.format.highlight', 'Highlight'),
      type: 'checkbox',
      ...
      label: t('menu.format.inlineCode', 'Inline Code'),
      type: 'checkbox',
      ...
      label: t('menu.format.inlineMath', 'Inline Math'),
      type: 'checkbox',
      ...
      id: 'strikeMenuItem',
      label: t('menu.format.strikethrough', 'Strikethrough'),
      type: 'checkbox',
      ...
      label: t('menu.format.hyperlink', 'Hyperlink'),
      type: 'checkbox',
      ...
      id: 'imageMenuItem',
      label: t('menu.format.image', 'Image'),
      type: 'checkbox',
      ...
      label: t('menu.format.clearFormatting', 'Clear Formatting'),
