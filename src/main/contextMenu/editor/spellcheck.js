...
export default (isMisspelled, misspelledWord, wordSuggestions) => {
  ...
  spellingSubmenu.push(new MenuItem({
    label: t('contextMenu.spellcheck.changeLanguage', 'Change Language...'),
  ...
  if (isMisspelled && misspelledWord && wordSuggestions) {
    spellingSubmenu.push({
      label: t('contextMenu.spellcheck.addToDictionary', 'Add to Dictionary'),
      click (menuItem, targetWindow) {
    ...
    spellingSubmenu.push({
      label: t('contextMenu.spellcheck.editDictionary', 'Edit Dictionary...'),
      click (menuItem, targetWindow) {
